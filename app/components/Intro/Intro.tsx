    ...
    <div className="container2 flex items-center flex-col lg:flex-row p-[60px_15px] lg:p-[50px_15px]">
      ...
      <div className="lg:max-w-[50%] px-[15px] mt-[50px] lg:mt-0 flex-grow">
        ...
        <p className="font-dancing text-2xl text-[#808080] leading-[50px] font-light mt-[25px] text-justify">
          Sứ mệnh của tôi là mang đến giai đoạn chuyển đổi số cho Trang Huy
          Logistic để thay đổi cách vận hành & quản trị doanh nghiệp. Với kinh
          nghiệm & năng lượng của người đứng đầu tôi tin sẽ chuyển đổi số thành
          công cho Trang Huy Logistic. Là người đam mê công nghệ tôi biết công
          việc chuyển đổi số sẽ gặp rất nhiều khó khăn, trở ngại nhưng tôi lại
          có một niềm tin mãnh liệt về một tương lai tươi sáng dành cho TrangHuy
          Logistic. Dành cho những con người dám nghĩ dám làm, nói như ngôn ngữ
          của người làm công nghệ là “Cứ máu có lẽ là xong”. Vâng rồi sẽ xong !
          Xong nhiệm vụ này rồi lại có nhiệm vụ khác lớn hơn, nhưng rồi tất cả
