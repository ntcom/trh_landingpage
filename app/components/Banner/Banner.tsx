    ...
    <div className="w-full h-[580px] md:h-[720px] xl:h-[1020px] relative">
      <div className="relative w-full h-full flex justify-center items-center">
        ...
        <div className="absolute mt-[50px] sm:mt-[80px] mds:mt-[150px] px-[25px]">
          ...
          <p className="font-poppins text-[32px] xsss:text-[36px] sm:text-[45px] md:text-[54px] lg:text-[80px] xl:text-[100px] text-[#fff] font-bold leading-[42px] xsss:leading-[52px] sm:leading-[62px] md:leading-[72px] lg:leading-[100px] xl:leading-[150px] text-center uppercase mb-[30px]">
